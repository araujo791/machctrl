...
export const translations = {
  pt: {
    ...
    active: 'ATIVO',
    consumption: 'Consumo',
    perfDesc: 'Performance · Turbo',
    cleaning: 'Limpando...',
    // Cleaner tasks (vindas do backend via ID)
    'pacman-cache':   'Cache do Pacman',
    'pacman-cache-d': 'Remove pacotes antigos (/var/cache/pacman/pkg)',
    'pacman-orphans':   'Pacotes Órfãos',
    'pacman-orphans-d': 'Remove pacotes sem dependentes instalados',
    'journal-logs':   'Logs do Journal',
    'journal-logs-d': 'Limpa logs do systemd (mantém últimos 7 dias)',
    'temp-files':   'Arquivos Temporários',
    'temp-files-d': 'Remove arquivos antigos de /tmp e /var/tmp',
    'thumb-cache':   'Cache de Miniaturas',
    'thumb-cache-d': 'Limpa thumbnails (~/.cache/thumbnails)',
    'coredumps':   'Core Dumps',
    'coredumps-d': 'Remove arquivos de crash do sistema',
    'trash':   'Lixeira',
    'pip-cache':   'Cache do Pip',
    'npm-cache':   'Cache do npm',
    'yarn-cache':   'Cache do Yarn',
    'docker-prune':   'Docker (imagens/containers)',
    'docker-prune-d': 'Remove imagens e containers parados',
    'flatpak-unused':   'Flatpak não usados',
    'flatpak-unused-d': 'Remove runtimes Flatpak desnecessários',
    // Benchmark
    benchTitle: 'Benchmark do Sistema',
    benchDesc: 'Testa CPU (matemática + ponto flutuante) e largura de banda da memória',
    start: 'Iniciar',
    readyTitle: 'Pronto para Benchmark',
  ...
  en: {
    ...
    'pacman-cache-d': 'Remove old packages (/var/cache/pacman/pkg)',
    'pacman-orphans':   'Orphan Packages',
    'pacman-orphans-d': 'Remove packages without installed dependents',
    'journal-logs':   'Journal Logs',
    'journal-logs-d': 'Clean systemd logs (keep last 7 days)',
    'temp-files':   'Temporary Files',
    'temp-files-d': 'Remove old files from /tmp and /var/tmp',
    'thumb-cache':   'Thumbnail Cache',
    'thumb-cache-d': 'Clean thumbnails (~/.cache/thumbnails)',
    'coredumps':   'Core Dumps',
    'coredumps-d': 'Remove system crash files',
    'trash':   'Trash',
    'pip-cache':   'Pip Cache',
    'npm-cache':   'npm Cache',
    'yarn-cache':   'Yarn Cache',
    'docker-prune':   'Docker (images/containers)',
    'docker-prune-d': 'Remove stopped images and containers',
    'flatpak-unused':   'Unused Flatpaks',
    'flatpak-unused-d': 'Remove unnecessary Flatpak runtimes',
    // Benchmark
    benchTitle: 'System Benchmark',
    benchDesc: 'Tests CPU (math + floating point) and memory bandwidth',
    start: 'Start',
    readyTitle: 'Ready for Benchmark',
